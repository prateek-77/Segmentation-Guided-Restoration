...
class ImageSegRestorationModel(BaseModel):
    """Base Deblur model for single image deblur."""

    def __init__(self, opt):
        super(ImageSegRestorationModel, self).__init__(opt)
    ...
    def feed_data(self, data, is_val=False):
        ...
        if 'seg' in data:
            ...
            raise ValueError("Seg Map not present!")
    ...
    def optimize_parameters(self, current_iter, tb_logger):
        ...
        preds = self.net_g(self.lq, self.seg)
